...
namespace UosCdn
{
    ...
    public class Parameters
    {
        ...
        public static string k_UosCdnSettingsPathPrefix = "Assets/Editor/UnityOnlineServiceData/";
        public static string k_UosSettingsPath = "Assets/Editor/UnityOnlineServiceData/UosSettings.asset";
        public static string k_UosCdnSettingsPath = "Assets/Editor/UnityOnlineServiceData/UosCdnSettings.asset";
        public static string k_UploadPartStatusPathPrefix = "Assets/Editor/UnityOnlineServiceData/";
        public static string k_UploadPartStatusFile = "Assets/Editor/UnityOnlineServiceData/unfinishedUploads.json";
