...
IL_000e:
	{
		...
		NullCheck(L_4);
		FieldInfo_t* L_6;
		L_6 = VirtualFuncInvoker2< FieldInfo_t*, String_t*, int32_t >::Invoke(121 /* System.Reflection.FieldInfo System.Type::GetField(System.String,System.Reflection.BindingFlags) */, L_4, L_5, ((int32_t)53));
		V_1 = L_6;
		// if (field == null)
		FieldInfo_t* L_7 = V_1;
		bool L_8;
...
IL_001f:
	{
		...
		NullCheck(L_5);
		bool L_7;
		L_7 = VirtualFuncInvoker1< bool, RuntimeObject* >::Invoke(165 /* System.Boolean System.Type::IsInstanceOfType(System.Object) */, L_5, L_6);
		if (L_7)
		{
			goto IL_002e;
		}
...
IL_0139:
	...
	}
	{
		...
		NullCheck(L_56);
		Type_t* L_57;
		L_57 = VirtualFuncInvoker0< Type_t* >::Invoke(167 /* System.Type System.Type::GetEnumUnderlyingType() */, L_56);
...
IL_002e:
	...
	}
	{
		...
		NullCheck(L_13);
		Type_t* L_14;
		L_14 = VirtualFuncInvoker0< Type_t* >::Invoke(47 /* System.Type System.Reflection.MethodInfo::get_ReturnType() */, L_13);
		return L_14;
	}
